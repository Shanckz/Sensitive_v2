namespace VRTK.Controllables.PhysicsBased
{
    ...
    public class boutonBureau : VRTK_BasePhysicsControllable
    {
        ...
        public static bool pressedDownBureau;
        ...
        protected override void OnEnable()
        {
            ...
            pressedDownBureau = false;
        }

        protected override void OnDisable()
        {
            if (stayPressed && pressedDownBureau)
            {
        ...
        protected virtual void Update()
        {
            ...
            SetTargetPosition();
            EmitEvents();
            if (!pressedDownBureau && stayPressed && AtMaxLimit())
            {
                StayPressed();
            }
        }
